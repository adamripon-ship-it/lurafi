...
const en = {
  ...
  configure: {
    ...
    lede: 'Kevin comes in Grey. Add optional, interchangeable front covers if you like — you are one step from a home that never looks empty.',
...
nl.configure = {
  ...
  title: 'Kies je Kevin.',
  lede: 'Kevin is er in Grey. Voeg desgewenst verwisselbare frontcovers toe — je bent één stap verwijderd van een huis dat nooit leeg lijkt.',
