...
const en = {
  ...
  hero: {
    ...
    slide_2: {
      ...
      image_alt: 'Kevin in a family home',
      callout_1_eyebrow: 'After school',
      callout_1_title: 'Home looks occupied',
      callout_1_body: 'Kevin keeps believable light and sound running when parents are delayed or out.',
      callout_2_eyebrow: 'No cameras',
      callout_2_title: 'Privacy first',
      callout_2_body: 'Simulation plays on the device — nothing records your family inside.',
      callout_3_eyebrow: 'Easy scenes',
      callout_3_title: 'One tap away',
      callout_3_body: 'Start a living-room scene from the Kevin app in seconds.'
    },
    slide_3: {
      label: 'Seniors & widows',
      image_alt: 'Kevin in a senior apartment',
      callout_1_eyebrow: 'Living alone',
      callout_1_title: 'Visible presence',
      callout_1_body: 'From the hallway or street, it looks like everyday life is happening inside.',
      callout_2_eyebrow: 'No monitoring',
      callout_2_title: 'Dignity intact',
      callout_2_body: 'Light, shadow, and household sound — not cameras or microphones.',
      callout_3_eyebrow: 'Routines',
      callout_3_title: 'Set weekly scenes',
      callout_3_body: 'Schedule believable activity while you rest easy at home.'
    },
    slide_4: {
      label: 'Women & single mothers',
      image_alt: 'Kevin in a luxury home',
      callout_1_eyebrow: 'Single mothers',
      callout_1_title: 'Occupied home',
      callout_1_body: 'Make your home feel lived-in before anyone tests the door or intercom.',
      callout_2_eyebrow: 'Women alone',
      callout_2_title: 'Confidence inside',
      callout_2_body: 'Visible deterrence without relying on an alarm that only reacts after entry.',
      callout_3_eyebrow: 'Night scenes',
      callout_3_title: 'Believable activity',
      callout_3_body: 'TV flicker, voices, and footsteps — varied so patterns never feel obvious.'
    },
    slide_5: {
      label: 'Students away from home',
      image_alt: 'Kevin in a student apartment',
      callout_1_eyebrow: 'First flat',
      callout_1_title: 'Away from home',
      callout_1_body: 'Help a new studio look less empty to neighbours in the hallway or courtyard below.',
      callout_2_eyebrow: 'Portable',
      callout_2_title: 'Room to room',
      callout_2_body: 'Move Kevin between bedroom and living area — or take it when you relocate.',
      callout_3_eyebrow: 'Quiet deterrence',
      callout_3_title: 'Exam season',
      callout_3_body: 'Presence simulation without blasting music through thin walls.'
    },
    slide_6: {
      label: 'Houseboat & unique homes',
      image_alt: 'Kevin on a Dutch houseboat',
      callout_1_eyebrow: 'Woonboot',
      callout_1_title: 'Life on the water',
      callout_1_body: 'Kevin runs believable scenes in a houseboat as easily as in a flat or villa.',
      callout_2_eyebrow: 'Portable',
      callout_2_title: 'Take it with you',
      callout_2_body: 'Move between home, boat, or holiday house — one device, multiple safe spaces.',
      callout_3_eyebrow: 'Away mode',
      callout_3_title: 'Quay-side quiet',
      callout_3_body: 'Light and sound vary automatically while you are ashore or travelling.'
    }
  },
  home: {},
